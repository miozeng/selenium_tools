...
/***/ "../../../../../src/app/layout/case/case-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__case_component__ = __webpack_require__("../../../../../src/app/layout/case/case.component.ts");
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CaseRoutingModule; });
...
var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_2__case_component__["a" /* CaseComponent */] }
];
var CaseRoutingModule = (function () {
    function CaseRoutingModule() {
    }
    return CaseRoutingModule;
}());
CaseRoutingModule = __decorate([
...
//# sourceMappingURL=case-routing.module.js.map

/***/ }),

/***/ "../../../../../src/app/layout/case/case.component.html":
/***/ (function(module, exports) {

module.exports = "<div [@routerTransition]>\n    <app-page-header [heading]=\"'Test Case List'\" [icon]=\"'fa-table'\"></app-page-header>\n    <div class=\"row\">\n        <div class=\"col col-xl-10 col-lg-12\">\n            <div class=\"card mb-3\">\n                <div class=\"card-header\">Module Rows\n                 <a [routerLink]=\"['/caseedit/'+ modulId +'/0']\" [routerLinkActive]=\"['router-link-active']\"  style=\"float: right;\">add</a>\n                </div>\n                <div class=\"card-block table-responsive\">\n                    <table class=\"table table-hover table-striped\">\n                        <thead>\n                        <tr>\n                            <th></th>\n                            <th>name</th>\n                            <th>description</th>\n                            <th>caseNo</th>\n                            <th>sequence</th>\n                            <th>success</th>\n                            <th>Step</th>\n                            <th>Edit</th>\n                            <th>Delete</th>\n                            <th>Run Test</th>\n                            <th>Download</th>\n                        </tr>\n                        </thead>\n                        <tbody>\n                        <tr *ngFor=\"let case of cases let i = index\">\n                            <td>{{i+1}}</td>\n                            <td> {{case.caseName}}</td>\n                            <td >{{case.caseDesc}}</td>\n                            <td >{{case.caseNo}}</td>\n                            <td >{{case.sequence}}</td>\n                            <td >{{case.success}}</td>\n                            <td><a [routerLink]=\"['/liststep/'+case.caseId]\" [routerLinkActive]=\"['router-link-active']\" >step</a></td>\n                            <td><a [routerLink]=\"['/caseedit/'+ modulId +'/'+case.caseId]\" [routerLinkActive]=\"['router-link-active']\" >edit</a></td>\n                             <td><a href=\"javascript:void(0);\" (click)=\"delete(case.caseId)\">Delete</a></td>\n                            <td><a href=\"javascript:void(0);\" (click)=\"runTest(case.caseId)\">Run test</a></td>\n                            <td><a href=\"javascript:void(0);\" (click)=\"download(case.caseId)\">Download</a></td>\n                        </tr>\n                        </tbody>\n                    </table>\n                </div>\n            </div>\n            <div class=\"row\">\n                <input type=\"file\" id=\"importfile\" ng2FileSelect [uploader]=\"importuploader\" *ngIf=\"importuploader.queue.length==0\" />\n         \t\t<button type=\"button\" class=\"btn btn-secondary\" (click)=\"import()\" [disabled]=\"!importuploader.getNotUploadedItems().length\"> Import Case</button>\n         \t</div>\n         \t<div class=\"row\">\t\n         \t\t<input type=\"file\" id=\"excutefile\" ng2FileSelect [uploader]=\"excuteuploader\"  *ngIf=\"excuteuploader.queue.length==0\"/>\n         \t\t<button type=\"button\" class=\"btn btn-secondary\" (click)=\"excute()\" [disabled]=\"!excuteuploader.getNotUploadedItems().length\"> Excute Cvs Case</button>\n         \t</div>\n         \t\n        </div>\n    </div>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/layout/case/case.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CaseComponent = (function () {
    function CaseComponent(layoutService, translate, route) {
        this.layoutService = layoutService;
        this.translate = translate;
        this.route = route;
        this.cases = [];
        this.browserLang = 'en';
        this.excuteuploader = new __WEBPACK_IMPORTED_MODULE_4_ng2_file_upload__["FileUploader"]({
    ...
    CaseComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) { return _this.modulId = params.moduleId; });
        this.importuploader = new __WEBPACK_IMPORTED_MODULE_4_ng2_file_upload__["FileUploader"]({
            url: this.layoutService.url_cvsimport(this.modulId),
            method: "POST",
            // itemAlias: "uploadedfile",
            autoUpload: false
        });
        this.importuploader.onCompleteItem = function (item, response, status, headers) {
        ...
        this.excuteuploader.onCompleteItem = function (item, response, status, headers) {
            console.log("item uploaded" + response);
            var responsePath = JSON.parse(response);
            if (responsePath.ret == true) {
            }
        ...
        if (this.modulId != 0) {
            this.layoutService.get_cases(this.modulId).subscribe(function (res) {
                _this.cases = res;
            });
        }
    };
    CaseComponent.prototype.runTest = function (caseId) {
        this.layoutService.run_case_test(caseId).subscribe(function (val) {
    ...
    CaseComponent.prototype.download = function (caseId) {
        this.layoutService.download_case_test(caseId);
    };
    CaseComponent.prototype.import = function () {
        this.importuploader.uploadAll();
    };
    CaseComponent.prototype.excute = function () {
        this.excuteuploader.uploadAll();
    };
    CaseComponent.prototype.delete = function (caseId) {
        if (confirm("delete it?")) {
            this.layoutService.delete_case_byid(caseId).subscribe(function (val) {
                console.log("POST call successful value returned in body", val);
            }, function (response) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__case_component__ = __webpack_require__("../../../../../src/app/layout/case/case.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__case_routing_module__ = __webpack_require__("../../../../../src/app/layout/case/case-routing.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_interceptor_http_interceptor__ = __webpack_require__("../../../../../src/app/shared/interceptor/http.interceptor.ts");
...
CaseModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__case_routing_module__["a" /* CaseRoutingModule */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_3__layout_service__["a" /* LayoutService */],
            { provide: __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["b" /* HTTP_INTERCEPTORS */], useClass: __WEBPACK_IMPORTED_MODULE_8__shared_interceptor_http_interceptor__["a" /* MyHttpLogInterceptor */], multi: true }],
        declarations: [__WEBPACK_IMPORTED_MODULE_4__case_component__["a" /* CaseComponent */]]
    })
], CaseModule);
